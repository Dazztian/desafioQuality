...
public class FlightSeatsTests {
    ...
    void shouldGetAllFlightSeats() throws Exception {
        ...
        this.mockMvc.perform(get(request))
                ...
                .andExpect(content().json("{\"statusCode\":{\"code\":\"200\",\"message\":\"Se han encontrado los siguientes asientos de avión disponibles\"},\"flightSeatsDTOSList\":[{\"flightNumber\":\"BAPI-1235\",\"origin\":\"Buenos Aires\",\"destination\":\"Puerto Iguazú\",\"seatType\":\"Economy\",\"price\":6,\"dateFrom\":\"10/02/2021\",\"dateTo\":\"15/02/2021\"},{\"flightNumber\":\"PIBA-1420\",\"origin\":\"Puerto Iguazú\",\"destination\":\"Bogotá\",\"seatType\":\"Business\",\"price\":43,\"dateFrom\":\"10/02/2021\",\"dateTo\":\"20/02/2021\"},{\"flightNumber\":\"PIBA-1420\",\"origin\":\"Puerto Iguazú\",\"destination\":\"Bogotá\",\"seatType\":\"Economy\",\"price\":25,\"dateFrom\":\"10/02/2021\",\"dateTo\":\"21/02/2021\"},{\"flightNumber\":\"BATU-5536\",\"origin\":\"Buenos Aires\",\"destination\":\"Tucumán\",\"seatType\":\"Economy\",\"price\":7,\"dateFrom\":\"10/02/2021\",\"dateTo\":\"17/02/2021\"},{\"flightNumber\":\"TUPI-3369\",\"origin\":\"Tucumán\",\"destination\":\"Puerto Iguazú\",\"seatType\":\"Business\",\"price\":12,\"dateFrom\":\"12/02/2021\",\"dateTo\":\"23/02/2021\"},{\"flightNumber\":\"TUPI-3369\",\"origin\":\"Tucumán\",\"destination\":\"Puerto Iguazú\",\"seatType\":\"Economy\",\"price\":5,\"dateFrom\":\"02/01/2021\",\"dateTo\":\"16/01/2021\"},{\"flightNumber\":\"BOCA-4213\",\"origin\":\"Bogotá\",\"destination\":\"Cartagena\",\"seatType\":\"Economy\",\"price\":8,\"dateFrom\":\"23/01/2021\",\"dateTo\":\"05/02/2021\"},{\"flightNumber\":\"CAME-0321\",\"origin\":\"Cartagena\",\"destination\":\"Medellín\",\"seatType\":\"Economy\",\"price\":7,\"dateFrom\":\"23/01/2021\",\"dateTo\":\"31/01/2021\"},{\"flightNumber\":\"BOBA-6567\",\"origin\":\"Bogotá\",\"destination\":\"Buenos Aires\",\"seatType\":\"Business\",\"price\":57,\"dateFrom\":\"15/02/2021\",\"dateTo\":\"28/02/2021\"},{\"flightNumber\":\"BOBA-6567\",\"origin\":\"Bogotá\",\"destination\":\"Buenos Aires\",\"seatType\":\"Economy\",\"price\":39,\"dateFrom\":\"01/03/2021\",\"dateTo\":\"14/03/2021\"},{\"flightNumber\":\"BOME-4442\",\"origin\":\"Bogotá\",\"destination\":\"Medellín\",\"seatType\":\"Economy\",\"price\":11,\"dateFrom\":\"10/02/2021\",\"dateTo\":\"24/02/2021\"},{\"flightNumber\":\"MEPI-9986\",\"origin\":\"Medellín\",\"destination\":\"Puerto Iguazú\",\"seatType\":\"Business\",\"price\":41,\"dateFrom\":\"17/04/2021\",\"dateTo\":\"02/05/2021\"}]}"));
    }
    ...
    void shouldGetFlightSeatsDestinationCartagena() throws Exception {
        ...
        this.mockMvc.perform(get(request))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().json("{\"statusCode\":{\"code\":\"200\",\"message\":\"Se han encontrado los siguientes asientos de avión disponibles\"},\"flightSeatsDTOSList\":[{\"flightNumber\":\"BOCA-4213\",\"origin\":\"Bogotá\",\"destination\":\"Cartagena\",\"seatType\":\"Economy\",\"price\":8,\"dateFrom\":\"23/01/2021\",\"dateTo\":\"05/02/2021\"}]}"));
    }
    ...
    void shouldGetFlightSeatsWhenAllParamsMatch() throws Exception {
        ...
        this.mockMvc.perform(get(request))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().json("{\"statusCode\":{\"code\":\"200\",\"message\":\"Se han encontrado los siguientes asientos de avión disponibles\"},\"flightSeatsDTOSList\":[{\"flightNumber\":\"TUPI-3369\",\"origin\":\"Tucumán\",\"destination\":\"Puerto Iguazú\",\"seatType\":\"Economy\",\"price\":5,\"dateFrom\":\"02/01/2021\",\"dateTo\":\"16/01/2021\"}]}"));
    }
